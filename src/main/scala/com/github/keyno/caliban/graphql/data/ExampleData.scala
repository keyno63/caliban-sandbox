package com.github.keyno.caliban.graphql.data

import com.github.keyno.caliban.graphql.data.ExampleData.Origin.{ BELT, EARTH, MARS }
import com.github.keyno.caliban.graphql.data.ExampleData.Role.{ Captain, Engineer, Mechanic, Pilot }
